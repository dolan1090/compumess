...
describe('Quickview listing', () => {
    ...
    Object.entries({
        ...
        it(`Case '${quickviewCase}': Shows a quickview when a product name is clicked and has a working carousel`, () => {
            ...
            cy.contains(selector.quickview.activePrefix + selector.quickview.headline, 'Product name');
            cy.contains(selector.quickview.product.price, '€10.00');
            ...
            cy.contains(selector.quickview.activePrefix + selector.quickview.headline, 'Second product');
            cy.contains(selector.quickview.activePrefix + selector.quickview.product.price, '€20.00');

            // Rotate back to first
            cy.quickviewNavigate('left');

            cy.contains(selector.quickview.activePrefix + selector.quickview.headline, 'Product name');
            cy.contains(selector.quickview.activePrefix + selector.quickview.product.price, '€10.00');
