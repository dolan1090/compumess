...
{
    final public const CONFIG_ROOT_CONSTRAINTS = '_root';

    public function __construct(
        private readonly ValidatorInterface $validator,
        private readonly FormGroupFieldTypeRegistry $typeRegistry,
    ...
    /**
     * @param array<string, Constraint|array<Constraint>|null> $fieldValidations
    ...
    private function decodeConfig(array $payload): ?array
    {
        ...
        $config = \json_decode((string) $payload['config'], true, 512, \JSON_THROW_ON_ERROR);
