...
class FormRoute extends AbstractFormRoute
{
    public function __construct(
        private readonly FormValidationFactory $formValidationFactory,
     ...
     * )
     */
    #[Route(path: '/store-api/swag/cms-extensions/form', name: 'store-api.swag.cms-extensions.form', methods: ['POST'], defaults: ['_captcha' => true])]
