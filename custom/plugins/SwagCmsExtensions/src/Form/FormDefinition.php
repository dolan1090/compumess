...
{
    final public const ENTITY_NAME = 'swag_cms_extensions_form';
    final public const CMS_SLOT_FOREIGN_KEY_STORAGE_NAME = 'cms_slot_id';
    final public const MAIL_TEMPLATE_FOREIGN_KEY_STORAGE_NAME = 'mail_template_id';
