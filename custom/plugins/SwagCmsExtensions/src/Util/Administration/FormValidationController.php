...
{
    final public const IS_FORM_VALIDATION = 'swagCmsExtensionsFormValidationStatus';
    ...
    #[Route(path: '/api/_action/swag/cms-extensions/form/validate', name: 'api.action.swag.cms-extensions.form.validate', methods: ['POST'], defaults: ['_acl' => ['cms.editor']])]
    ...
    #[Route(path: '/api/_action/swag/cms-extensions/form/validateAll', name: 'api.action.swag.cms-extensions.form.validate-all', methods: ['POST'], defaults: ['_acl' => ['cms.editor']])]
