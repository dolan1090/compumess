...
{
    final public const SWAG_CMS_EXTENSIONS_FEATURE_FORM_BUILDER = 'form_builder';
    final public const SWAG_CMS_EXTENSIONS_FEATURE_QUICKVIEW = 'quickview';
    final public const SWAG_CMS_EXTENSIONS_FEATURE_BLOCK_RULE = 'block_rule';
    final public const SWAG_CMS_EXTENSIONS_FEATURE_SCROLL_NAVIGATION = 'scroll_navigation';
