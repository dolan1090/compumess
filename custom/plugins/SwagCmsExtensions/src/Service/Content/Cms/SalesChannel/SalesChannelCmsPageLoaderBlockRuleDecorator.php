...
use Swag\CmsExtensions\Extension\Feature\BlockRule\CmsBlockEntityExtension;
use Symfony\Component\HttpFoundation\Request;

class SalesChannelCmsPageLoaderBlockRuleDecorator implements SalesChannelCmsPageLoaderInterface
{
    final public const BLOCK_RULE_ASSOCIATION_PATH
        = 'sections.blocks.' . CmsBlockEntityExtension::BLOCK_RULE_ASSOCIATION_PROPERTY_NAME;
    final public const BLOCK_RULE_VISIBILITY_RULE_ASSOCIATION_PATH
        = self::BLOCK_RULE_ASSOCIATION_PATH . '.visibilityRule';
