...
{
    final public const SCROLL_NAVIGATION_PAGE_SETTINGS_PATH
        = CmsPageEntityExtension::SCROLL_NAVIGATION_PAGE_SETTINGS_PROPERTY_NAME;
    final public const SCROLL_NAVIGATION_ASSOCIATION_PATH
        = 'sections.' . CmsSectionEntityExtension::SCROLL_NAVIGATION_ASSOCIATION_PROPERTY_NAME;
