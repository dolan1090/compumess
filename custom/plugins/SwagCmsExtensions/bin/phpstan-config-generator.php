...
$swagCmsExtensions = [
    ...
    'baseClass' => SwagCmsExtensions::class,
...
$pluginLoader = new StaticKernelPluginLoader($classLoader, null, [$swagCmsExtensions]);
...
$relativeCacheDir = \str_replace($projectDir, '', (string) $cacheDir);

$phpStanConfigDist = \file_get_contents(__DIR__ . '/../phpstan.neon');
