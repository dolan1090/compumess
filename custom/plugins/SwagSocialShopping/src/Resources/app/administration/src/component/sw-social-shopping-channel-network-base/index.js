...
Component.register('sw-social-shopping-channel-network-base', {
    ...
    computed: {
        ...mapPropertyErrors(
            ...
            [
                'name',
                'socialShoppingSalesChannel.salesChannelDomainId',
                'currencyId',
            ],
        ),
    ...
    methods: {
        ...
        changeInterval() {
            ...
            this.salesChannel.extensions.socialShoppingSalesChannel.configuration.generateByCronjob = !this.disableGenerateByCronjob;
        },
        ...
        supportsFavorites() {
            return this.salesChannelFavoritesService !== undefined;
        },

        syncProductStreamId(productStreamId) {
            if (this.salesChannel.productExports[0]) {
                this.salesChannel.productExports[0].productStreamId = productStreamId;
            }
