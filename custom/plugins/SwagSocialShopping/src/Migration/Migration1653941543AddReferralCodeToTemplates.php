...
class Migration1653941543AddReferralCodeToTemplates extends MigrationStep
{
    ...
    public static function getTemplate(string $templateName): string
    {
        switch ($templateName) {
            case 'old_facebook':
                return (string) \file_get_contents(__DIR__ . '/fixtures/Migration1653941543AddReferralCodeToTemplates/body_old_facebook.xml');
            case 'old_google':
                return (string) \file_get_contents(__DIR__ . '/fixtures/Migration1653941543AddReferralCodeToTemplates/body_old_google.xml');
            case 'new_facebook':
