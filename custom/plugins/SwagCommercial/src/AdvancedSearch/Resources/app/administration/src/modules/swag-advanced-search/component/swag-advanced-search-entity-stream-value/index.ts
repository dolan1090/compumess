...
import template from './swag-advanced-search-entity-stream-value.html';
import './swag-advanced-search-entity-stream-value.scss';
...
export default {
    ...
    computed: {
        repository() {
            return licenseDecoratorHelper(this.repositoryFactory.create(this.definition.entity), LICENSE_TRAP_PRIMARY);
        },
        ...
        fieldDefinition() {
            return this.definition.getField(this.fieldName);
        },
