...
class Migration1624512389ProductRule extends MigrationStep
{
...
CREATE TABLE IF NOT EXISTS `#table#` (
    ...
    CONSTRAINT `fk.swag_dynamic_access_product_rule_#ref1#`
        FOREIGN KEY (`#ref1#_id`, `#ref1#_version_id`) REFERENCES `#ref1#` (`id`, `version_id`)
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    CONSTRAINT `fk.swag_dynamic_access_product_rule_#ref2#`
...
SQL;
        ...
        $connection->executeStatement(\str_replace(
            ...
            [ProductRuleDefinition::ENTITY_NAME, ProductDefinition::ENTITY_NAME, RuleDefinition::ENTITY_NAME, Uuid::fromHexToBytes(Defaults::LIVE_VERSION)],
            $sql
        ));
    }
