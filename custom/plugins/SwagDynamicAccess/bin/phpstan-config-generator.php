...
use Swag\DynamicAccess\SwagDynamicAccess;
...
$swagDynamicAccess = [
    ...
    'baseClass' => SwagDynamicAccess::class,
    'name' => 'SwagDynamicAccess',
    'version' => $composerJson['version'],
    'active' => true,
    'path' => $pluginRootPath,
    'managedByComposer' => false,
];
$pluginLoader = new StaticKernelPluginLoader($classLoader, null, [$swagDynamicAccess]);
