...
use Swag\CustomizedProducts\Core\Checkout\Cart\Route\AddCustomizedProductsToCartIdentifierExtension;
...
class LineItemAddedSubscriberTest extends TestCase
{
    ...
    public function testOnLineItemAddedToCartWithCustomProduct(): void
    {
        ...
        $cart = new Cart('mytoken');
        $cart->addLineItems(new LineItemCollection([$lineItem]));

        $event = new BeforeLineItemAddedEvent(
            $lineItem,
            $cart,
    ...
    public function testOnLineItemAddedToCartWithAddToCartExtension(): void
    {
        ...
        $lineItem->setRemovable(true);
        $lineItem->addExtension(CustomizedProductsCartController::ADD_TO_CART_IDENTIFIER, new AddCustomizedProductsToCartIdentifierExtension());
