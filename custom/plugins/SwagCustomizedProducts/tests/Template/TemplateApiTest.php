...
use Swag\CustomizedProducts\Template\Aggregate\TemplateOptionPrice\TemplateOptionPriceCollection;
...
use Swag\CustomizedProducts\Template\Aggregate\TemplateOptionValuePrice\TemplateOptionValuePriceCollection;
use Swag\CustomizedProducts\Template\Aggregate\TemplateOptionValuePrice\TemplateOptionValuePriceEntity;
...
class TemplateApiTest extends TestCase
{
    ...
    public function testCreateTemplateWithOptionPrices(): void
    {
        ...
        static::assertInstanceOf(TemplateOptionPriceCollection::class, $prices);
        $firstPrice = $prices->first();
        static::assertInstanceOf(TemplateOptionPriceEntity::class, $firstPrice);
        static::assertSame($optionId, $firstPrice->getTemplateOptionId());

        $priceCollection = $firstPrice->getPrice();
        static::assertInstanceOf(PriceCollection::class, $priceCollection);
    ...
    public function testCreateTemplateWithOptionValuePrices(): void
    {
        ...
        $firstOption = $options->first();
        static::assertInstanceOf(TemplateOptionEntity::class, $firstOption);
        static::assertSame($optionId, $firstOption->getId());

        $values = $firstOption->getValues();
        static::assertInstanceOf(TemplateOptionValueCollection::class, $values);

        $firstValue = $values->first();
        static::assertInstanceOf(TemplateOptionValueEntity::class, $firstValue);
        ...
        static::assertInstanceOf(TemplateOptionValuePriceCollection::class, $valuePrices);

        $firstPrice = $valuePrices->first();
        static::assertInstanceOf(TemplateOptionValuePriceEntity::class, $firstPrice);
    ...
    public function testAddTemplateToProduct(): void
    {
        ...
        $this->getBrowser()->request(
            'PATCH',
            '/api/swag-customized-products-template/' . $templateId . '/products/' . $productId,
            [],
            [],
            [],
    ...
    public function testTemplateCanBeDeleted(): void
    {
        $templateId = Uuid::randomHex();
        $this->createTemplate(
            [
        ...
        $this->getBrowser()->request(
            'DELETE',
            \sprintf('/api/swag-customized-products-template/%s', $templateId)
        );
        static::assertSame(
            Response::HTTP_NO_CONTENT,
            $this->getBrowser()->getResponse()->getStatusCode(),
