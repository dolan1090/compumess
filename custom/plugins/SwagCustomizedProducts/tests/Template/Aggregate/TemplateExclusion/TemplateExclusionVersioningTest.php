...
class TemplateExclusionVersioningTest extends TestCase
{
    ...
    private EntityRepository $exclusionRepository;
    ...
    protected function setUp(): void
    {
        ...
        $operatorRepository = $container->get('swag_customized_products_template_exclusion_operator.repository');
        $this->operatorRepository = $operatorRepository;
        /** @var EntityRepository $exclusionRepository */
        $exclusionRepository = $container->get('swag_customized_products_template_exclusion.repository');
    ...
    public function testThatTemplateExclusionsVersionize(): void
    {
        ...
        static::assertSame($versionId, \mb_strtolower((string) $res['version_id']));
        ...
        static::assertArrayHasKey('count', $res);
        static::assertSame(1, (int) $res['count']);
        static::assertSame(Defaults::LIVE_VERSION, \mb_strtolower((string) $res['version_id']));
