...
class TemplateDecisionTreeGeneratorTest extends TestCase
{
    ...
    private TemplateDecisionTreeGeneratorInterface $generator;

    private EntityRepository $operatorRepository;

    protected function setUp(): void
    {
        $container = $this->getContainer();
        /** @var TemplateDecisionTreeGeneratorInterface $generator */
        $generator = $container->get(TemplateDecisionTreeGenerator::class);
        $this->generator = $generator;
        /** @var EntityRepository $operatorRepository */
        $operatorRepository = $container->get(TemplateExclusionOperatorDefinition::ENTITY_NAME . '.repository');
    ...
    public function testGenerate(): void
    {
        ...
        $templateRepository = $this->getContainer()->get(TemplateDefinition::ENTITY_NAME . '.repository');
        /** @var TemplateEntity|null $template */
        $template = $templateRepository->search(new Criteria([$templateId]), $context)->first();
