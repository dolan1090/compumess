...
{
    final public const SWAG_CUSTOMIZED_PRODUCTS_TEMPLATE_INHERITED_CUSTOM_FIELD = 'swagCustomizedProductsTemplateInherited';
    ...
    public function onProductVariantWrittenInitializeCustomFields(EntityWrittenEvent $event): void
    {
        ...
        foreach ($event->getPayloads() as $payload) {
            ...
            if (!\array_key_exists('parentId', $payload) || $payload['parentId'] === null) {
                continue;
            }

            // Exit if a template is explicitly written to a variant to differ from the parent
