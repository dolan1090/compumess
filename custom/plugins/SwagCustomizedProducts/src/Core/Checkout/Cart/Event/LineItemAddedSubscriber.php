...
class LineItemAddedSubscriber implements EventSubscriberInterface
{
    ...
    {
        return [
            BeforeLineItemAddedEvent::class => 'onLineItemAddedToCart',
        ];
    }

    public function onLineItemAddedToCart(BeforeLineItemAddedEvent $event): void
    {
        ...
        // Custom product is added by order number and has to be removed
