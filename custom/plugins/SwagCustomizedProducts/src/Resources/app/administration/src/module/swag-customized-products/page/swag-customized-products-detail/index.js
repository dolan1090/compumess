...
Component.register('swag-customized-products-detail', {
    ...
    methods: {
        ...
        handleRouteLeave(next) {
            this.SwagCustomizedProductsTemplateApiService.deleteVersion(this.templateId, this.versionContext.versionId);
            next();
        },
        ...
        async onDuplicateSave() {
            ...
            const criteria = this.templateCriteria
                ...
                .addAssociation('options.templateExclusionConditions')
