...
import './component/swag-customized-products-tree-item-position';
import './component/swag-customized-products-option-list';
import './component/swag-customized-products-nullable-number-field';
...
import './component/option-type-forms/option-type-tree/swag-customized-products-option-tree-default-select';
...
Module.register('swag-customized-products', {
    ...
    routes: {
        index: {
            ...
            path: 'index',
            meta: {
                privilege: 'swag_customized_products_template.viewer',
            },
        },
        ...
        create: {
            ...
            children: {
                base: {
                    ...
                    path: 'base',
                    meta: {
                        privilege: 'swag_customized_products_template.creator',
                        parentPath: 'swag.customized.products.index',
                    },
                },
            },
