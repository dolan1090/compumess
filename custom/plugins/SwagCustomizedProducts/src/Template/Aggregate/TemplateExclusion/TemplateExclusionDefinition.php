...
{
    final public const ENTITY_NAME = 'swag_customized_products_template_exclusion';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new OneToManyAssociationField('conditions', TemplateExclusionConditionDefinition::class, 'template_exclusion_id'))
