...
{
    final public const ENTITY_NAME = 'swag_customized_products_template_exclusion_condition';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('template_exclusion_id', 'templateExclusionId', TemplateExclusionDefinition::class))
            ...
            (new ReferenceVersionField(TemplateExclusionDefinition::class, 'template_exclusion_version_id'))
                ->addFlags(new Required(), new ApiAware()),
            ...
            (new FkField(
                ...
                TemplateExclusionOperatorDefinition::class
            ))->addFlags(new Required(), new ApiAware()),
