...
{
    final public const ENTITY_NAME = 'swag_customized_products_template_exclusion_condition_values';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            // Normally these fields are default fields, but are overwritten in the MappingEntityDefinition
            new CreatedAtField(),
            new UpdatedAtField(),
        ]);
    }
