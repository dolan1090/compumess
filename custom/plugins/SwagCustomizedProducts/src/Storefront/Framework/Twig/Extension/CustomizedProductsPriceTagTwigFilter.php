...
class CustomizedProductsPriceTagTwigFilter extends AbstractExtension
{
    public function __construct(
        private readonly CurrencyFilter $currencyFilter,
    ...
    public function generatePriceTag(array $twigContext, OrderLineItemEntity|LineItem $lineItem, string $prefix = '', string $suffix = ''): ?string
    {
